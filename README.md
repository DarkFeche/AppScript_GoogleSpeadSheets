...
Los scripts en esta colección varían desde disparadores simples tipo onOpen hasta tareas de automatización complejas vinculadas a triggers diarios. Aunque esto empezó como una colección de soluciones dispersas, actualmente estoy reestructurando el código hacia un formato más modular y reutilizable para mejorar la escalabilidad y el mantenimiento.
